...
import { HeartPulse, Mail, Lock, User, ArrowRight, AlertCircle, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-900 via-slate-950 to-brand-950 text-white relative">
      <div className="w-full max-w-md rounded-3xl glass-card border border-white/10 p-8 shadow-2xl relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <h2 className="text-2xl font-extrabold text-white">Create PillSync Account</h2>
          <p className="text-xs text-slate-400 mt-1">Register as Patient, Caregiver, or Admin</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            >
              <option value="patient" className="bg-slate-900">Patient Profile</option>
              <option value="caregiver" className="bg-slate-900">Caregiver Profile</option>
              <option value="admin" className="bg-slate-900">Administrator Profile</option>
            </select>
          </div>
        ...
        <p className="mt-4 text-center text-xs text-slate-400">
          Already have an account? <Link to="/login" className="text-brand-400 font-bold underline">Sign In</Link>
        </p>
