...
const ICON_PATHS = {
  scan: (
    <>
      <path d="M4 8V5a1 1 0 0 1 1-1h3M16 4h3a1 1 0 0 1 1 1v3M20 16v3a1 1 0 0 1-1 1h-3M8 20H5a1 1 0 0 1-1-1v-3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
  ...
  pill: (
    <>
      <rect x="4" y="10.5" width="16" height="7" rx="3.5" transform="rotate(-35 12 14)" stroke="currentColor" strokeWidth="2" />
  ...
  refill: (
    <>
      <path d="M6 4h12M6 4v5.5a3 3 0 0 0 1.2 2.4L9 13v4a3 3 0 0 0 3 3v0a3 3 0 0 0 3-3v-4l1.8-1.1A3 3 0 0 0 18 9.5V4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </>
  ),
  chart: (
    <>
  ...
  leaf: (
    <>
      <path d="M5 19c8 0 14-6 14-14-8 0-14 6-14 14Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
      <path d="M5 19c0-4 2-7 5-9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </>
  ),
  dumbbell: (
    <>
      <path d="M4 10v4M7 8v8M17 8v8M20 10v4M7 12h10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </>
  ),
  flame: (
    <>
        ...
        <nav className="flex flex-1 flex-col gap-1">
          {items.map((item) => (
            <NavLink
              ...
              style={({ isActive }) =>
                isActive ? { backgroundColor: "var(--brand-soft)", color: "var(--brand-deep)" } : undefined
              }
            >
              <Icon name={item.icon} />
              {item.label}
